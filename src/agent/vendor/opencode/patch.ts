// Sourced from opencode/packages/opencode/src/patch/index.ts
// EXTRACT: pure parsePatch + deriveNewContentsFromChunks; Effect/FS/Bom stripped.
...
export function deriveNewContentsFromChunks(
  ...
  const unifiedDiff = generateUnifiedDiff(originalText, newContent)
